...
class _MyHomePageState extends State<TableView> {
  ...
  void _updateAndDeleteTable(
      BuildContext context,
      TextEditingController nameOfTable,
      TextEditingController numberOfSeats,
      int index,
      String id) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        AppComponents.textWithRegular("Name of Table", 12,
                            color: Colors.white),
                        SizedBox(
                          height: 11,
                        ),
                        // AppComponents.shadowTextField(
                        //     nameOfTable, null, "Table Name", null,
                        //     defaultMargin: 0, enable: true),

                        SizedBox(
                          height: 22,
                        ),
                        AppComponents.textWithRegular("Number of Seat", 12,
                            color: Colors.white),
                        SizedBox(
                          height: 11,
                        ),
                        // AppComponents.shadowTextField(
                        //     numberOfSeats, null, "Seat", null,
                        //     defaultMargin: 0, enable: true),
                        SizedBox(
                          height: 22,
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                                child: AppComponents.createButton(
                                    "Update", () {})),
                            const SizedBox(
                              width: 20,
                            ),
